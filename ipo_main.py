...
from openrlhf.trainer import OnlineIPOPPOTrainer
...
def train(args):
    ...
    trainer = OnlineIPOPPOTrainer(
        ...
        rejection_batch_size=args.rejection_batch_size,
        # fro GPT generation
        do_sample=True,
        ...
        # we can add  num_return_sequences here
    )
...
if __name__ == "__main__":
    ...
    # Checkpoint
    parser.add_argument("--save_path", type=str, default="/root/autodl-tmp/ckpt/checkpoints_OnlineIPO")
    parser.add_argument("--save_steps", type=int, default=-1)
    parser.add_argument("--logging_steps", type=int, default=1)
    parser.add_argument("--eval_steps", type=int, default=-1)
    parser.add_argument("--ckpt_path", type=str, default="/root/autodl-tmp/ckpt/checkpoints_OnlineIPO")
    ...
    parser.add_argument("--actor_batch_size", type=int, default=1, help="the batch_size for actor model")
    parser.add_argument("--rejection_batch_size",  type=int, default=1, help="the batch_size for rejection sampling")
