...
from .ppo_utils import AdaptiveKLController, Experience, FixedKLController, NashRSNaiveExperienceMaker, NaiveReplayBuffer


class NashRSPPOTrainer(ABC):
    """
    ...
    def __init__(
        ...
        **generate_kwargs,
        ...
        self.experience_maker = NashRSNaiveExperienceMaker(
