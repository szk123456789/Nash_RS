...
from openrlhf.models.NashRS_utils import NashRSRejectionSamplingReward, compute_reward
...
class NashRSNaiveExperienceMaker(ABC):
    """
    ...
    def make_experience(self, prompts: Union[str, List[str]], **generate_kwargs) -> Experience:
        ...
        # rewards
        r = NashRSRejectionSamplingReward(
            sequences=sequences,
...
class NashRSRemoteExperienceMaker(NashRSNaiveExperienceMaker):
