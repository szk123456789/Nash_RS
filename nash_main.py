...
from openrlhf.trainer import NashRSPPOTrainer
...
if __name__ == "__main__":
    ...
    # Checkpoint
    parser.add_argument("--save_path", type=str, default="/root/autodl-tmp/ckpt/checkpoints_NashRS")
    parser.add_argument("--save_steps", type=int, default=-1)
    parser.add_argument("--logging_steps", type=int, default=1)
    parser.add_argument("--eval_steps", type=int, default=-1)
    parser.add_argument("--ckpt_path", type=str, default="/root/autodl-tmp/ckpt/checkpoints_NashRS")
